...
| [memory-lancedb-pro](https://github.com/CortexReach/memory-lancedb-pro) 4457★ 收藏🌐 | OpenClaw 增强 LanceDB 记忆插件:混合检索(Vector+BM25)+ 跨编码器。 | OpenClaw、记忆插件、LanceDB、混合检索 |
| [clawdbot-feishu](https://github.com/m1heng/clawdbot-feishu) 4245★ 收藏🌐 | OpenClaw 的飞书/Lark 通道插件,用于接收和发送飞书消息并配置事件订阅。 | OpenClaw、飞书、Lark、聊天机器人、通道插件、消息 |
| [PilotDeck](https://github.com/OpenBMB/PilotDeck) 3986★ 收藏🌐 | 面向任务的 AI Agent 生产力平台(OpenBMB)。 | Agent平台、任务编排、生产力、OpenBMB |
