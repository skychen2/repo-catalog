...
| [SoulX-Podcast](https://github.com/Soul-AILab/SoulX-Podcast) 3546★ 收藏🌐 | SoulX-Podcast:高保真播客生成推理代码库(Soul AI)。 | 播客生成、TTS、语音合成、高保真 |
| [bilive](https://github.com/timerring/bilive) 3283★ 收藏🌐 | 极快的 B 站直播录制、自动切片、自动渲染弹幕字幕并投稿。 | B站、直播录制、自动切片、投稿 |
| [fogsight](https://github.com/fogsightai/fogsight) 2553★ 收藏🌐 | LLM 驱动的 AI agent 与动画引擎。 | 动画引擎、LLM、agent、创作 |
